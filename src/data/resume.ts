export const resumeData = {
  ...
  competencies: [
    ...
    "SLA Management & First Call Resolution",
    "ITIL Framework",
    "Ticketing Systems",
  ...
  experience: [
    {
      ...
      highlights: [
        ...
        "Monitored system alerts and performed proactive maintenance to prevent service disruptions"
      ]
    },
    {
  ...
  projects: [
    {
      name: "MarketInfoIND – Financial News & Education Platform",
      link: "https://marketinfoind.com",
      github: "https://github.com/ajayh123-eng/MarketInfoIND",
      description: "Independently built and deployed a full-stack financial news website focused on Indian markets using modern web technologies—achieved entirely through AI-assisted development without prior coding experience, demonstrating exceptional self-learning ability and technical aptitude.",
      stack: ["React 18", "TypeScript", "Vite", "Tailwind CSS", "Supabase", "React Router 7", "TanStack Query", "Vercel", "Git/GitHub"],
      highlights: [
        "Designed and deployed a responsive, mobile-first Single Page Application (SPA) with dynamic article routing and SEO optimization",
        "Implemented secure Markdown content rendering with XSS protection using DOMPurify and marked libraries",
  ...
  skills: {
    "Operating Systems": ["Windows 7/10/11", "Windows Server basics", "macOS basics", "Linux fundamentals"],
    "Applications & Tools": ["Microsoft 365 Suite (Outlook, Teams, OneDrive, SharePoint)", "Active Directory", "VPN clients"],
    "ITSM Tools": ["ServiceNow", "Jira Service Management", "SAP CRM"],
    "Remote Support": ["TeamViewer", "Remote Desktop Protocol", "VNC", "AnyDesk"],
    "Networking": ["TCP/IP basics", "DNS", "DHCP", "VPN troubleshooting", "network diagnostics"],
    "Hardware": ["Desktop/Laptop troubleshooting", "printer support", "peripheral configuration"],
    "Development & Database": ["React", "TypeScript", "Git/GitHub", "MySQL", "MongoDB", "Supabase", "REST APIs"],
    "Analytics & Reporting": ["Power BI", "Microsoft Excel (Advanced)", "SQL queries", "data visualization"],
    "Cloud & Deployment": ["Vercel", "basic cloud concepts", "CI/CD principles"],
    "Methodologies": ["ITIL Framework", "SLA Management", "Incident Management", "Change Management", "Agile basics"]
  },
  education: [
    {
      degree: "Bachelor of Technology (B.Tech) in Electrical & Electronics Engineering",
      institution: "Shridevi Institute of Technology",
      location: "Tumakuru, Karnataka"
    }
  ],
  certifications: [
    "ServiceNow Administration & ITSM best practices",
    "ITIL Foundation concepts and incident management",
    "Microsoft 365 Administration and troubleshooting",
    "Modern Web Development (React, TypeScript, full-stack development)",
